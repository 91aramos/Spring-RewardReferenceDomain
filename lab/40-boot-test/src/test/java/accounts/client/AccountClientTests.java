...
// Done: Make this class a Spring Boot test class
// - Add @SpringBootTest annotation with WebEnvironment.RANDOM_PORT
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
public class AccountClientTests {

	// DONE: Autowire TestRestTemplate bean to a field
	// - Name the field as restTemplate
	@Autowired
	private TestRestTemplate restTemplate;

	// DONE: Update code below to use TestRestTemplate (as opposed to RestTemplate)
	...
	// DONE: Modify the code below so that it handles 404 HTTP response status
	...
	// DONE: Observe a log message in the console indicating
