...
// DONE: Get yourself familiarized with various testing utility classes
...
// Done: Replace @ExtendWith(SpringExtension.class) with the following annotation
// - @WebMvcTest(AccountController.class) // includes @ExtendWith(SpringExtension.class)
@WebMvcTest(AccountController.class)
public class AccountControllerBootTests {

	// DONE: Autowire MockMvc bean
	@Autowired
	private MockMvc mockMvc;

	// DONE: Create AccountManager mock bean using @MockBean annotation
	@MockBean
	private AccountManager accountManager;

	// DONE: Write positive test for GET request for an account
	...
	// DONE: Write negative test for GET request for a non-existent account
