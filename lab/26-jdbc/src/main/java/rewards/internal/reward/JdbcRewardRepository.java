...
// DONE : Inject JdbcTemplate directly to this repository class
...
// DONE: Refactor the cumbersome low-level JDBC code in JdbcRewardRepository with JdbcTemplate.
...
public class JdbcRewardRepository implements RewardRepository {
	...
	public JdbcRewardRepository(JdbcTemplate template) {
