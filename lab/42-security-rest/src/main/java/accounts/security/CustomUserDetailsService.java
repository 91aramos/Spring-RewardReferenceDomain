...
//DONE: Create custom UserDetailsService
...
//DONE (Optional): Add authentication based upon the custom UserDetailsService
//- Annotate the class with @Component to make it a Spring manager bean

//DONE: Remove the CustomUserDetailsService definition
